...
def buttonreleased():
    ...
    elif end - start >= 1.0 and end - start <= 3.5:
        print(" ", end='')
        decode += " "
    elif end - start >= 3.5 and end - start <= 5:
        pass
    elif end - start >= 0.5 and end - start <= 0.9:
        print("-", end='')
        decode += "-"
    start = time.time()

button.when_released = buttonreleased
print("Enter morse code: ", end='')
while not done:
    sleep(1)
...
while len(decode)>0:
    # print("DEBUG",  decode)from gpiozero import Button
from time import sleep
import time
import sys
button = Button(6)
